...
class BaseDeDatos {
  constructor() {
    ...
    this.productos = [];
    // Apenas se instancia la case BaseDeDatos, llamo
  ...
  // Devuelve un array con todas las coincidencias que encuentre según el
  ...
  // Devuelve un array con todos los productos que tengan la categoría
...
// Muestro el catálogo de la base de datos apenas carga la página
cargarProductos(bd.traerRegistros());
